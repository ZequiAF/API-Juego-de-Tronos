  ...
  return (
    <>
      <div className="col-mx-3 col-md-4 col-sm-12">
        <div className="card2">
          <Paragrhafing label="---------------------------" />
          <p><span className="resultado__titulosformat">Titulo:</span><span className="resultado__parrafoformat"> {resultado[0].name}</span></p>
          <p><span className="resultado__titulosformat">Casa:</span><span className="resultado__parrafoformat"> {resultado[0].slug}</span></p>
          <p><span className="resultado__titulosformat">Miembros:</span></p>
          <ul>
